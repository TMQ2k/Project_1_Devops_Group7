...
class MediaControllerTest {
    ...
    void create_shouldReturnOk() {
        ...
        MediaPostVm mediaPostVm = new MediaPostVm("caption", file, "override.png");
    ...
    @Test
    void get_whenMediaExists_shouldReturnOk() {
    ...
    @Test
    void get_whenMediaNotFound_shouldReturnNotFound() {
    ...
    @Test
    void getByIds_whenMediasExist_shouldReturnOk() {
        MediaVm mediaVm = new MediaVm(1L, "caption", "file.png", "image/png", "/url");
    ...
    void getFile_shouldReturnFileResponse() {
        ...
        ResponseEntity<?> response = mediaController.getFile(1L, "file.png");
