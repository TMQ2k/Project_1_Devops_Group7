...
class MessagesUtilsTest {
    ...
    void testGetMessage_whenValidMessageCode_thenReturnMessage() {
        String result = MessagesUtils.getMessage(Constants.ErrorCode.RATING_NOT_FOUND);
    ...
    void testGetMessage_whenMessageCodeWithParameters_thenReturnFormattedMessage() {
        String result = MessagesUtils.getMessage(Constants.ErrorCode.RATING_NOT_FOUND, "123");
        assertNotNull(result);
    }

    @Test
    void testGetMessage_whenMessageCodeWithMultipleParameters_thenReturnFormattedMessage() {
        String result = MessagesUtils.getMessage(Constants.ErrorCode.RATING_NOT_FOUND, "Param1", "Param2");
        assertNotNull(result);
    }
}
